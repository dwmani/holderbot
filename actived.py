            ...
            if STATUS == "on" :
                ...
                if RESPONCE.status_code == 200 :
                    ...
                    for USER in RESPONCE_DATA["users"] :
                        if not USER["inbounds"] == {'vmess': ['VMESS Websocket'], 'vless': ['DE-TUN', 'NE-TUN', 'EN-TUN', 'FR-TUN', 'PL-TUN', 'DE2-TUN', 'NE2-TUN', 'EN2-TUN', 'FR2-TUN', 'TR-TUN']} :
                            USERNAME = USER["username"]
                            URL = f"https://{PANEL_DOMAIN}/api/user/{USERNAME}"
                            DATA = {"proxies":{"vmess":{}, "vless":{}},"inbounds" : {'vmess': ['VMESS Websocket'], 'vless': ['DE-TUN', 'NE-TUN', 'EN-TUN', 'FR-TUN', 'PL-TUN', 'DE2-TUN', 'NE2-TUN', 'EN2-TUN', 'FR2-TUN', 'TR-TUN']}}

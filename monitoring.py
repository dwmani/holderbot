                ...
                if RESPONCE.status_code == 200 :
                    ...
                    for NODE in RESPONCE_DATA :
                        ...
                        if NODE.get("status") == "error" or NODE.get("status") == "connecting" :
                            ...
                            TEXT = f"<b>❗️ boss of one of the servers crashed. To prevent spamming, server monitoring has been stopped and will be restarted after <code>{CHECK_ERROR}</code> seconds.</b>"
                            ...
                            app.send_message(chat_id=BOSS_CHATID , text=DEF_RECONNECT_NODE(BOSS_CHATID , NODE.get('id')) , parse_mode=enums.ParseMode.HTML)
